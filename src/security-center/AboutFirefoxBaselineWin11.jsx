...
export default function AboutFirefoxBaselineWin11() {
  const handleOpenTool = () => {
    window.location.href = '/security-center/browser-hardening-hub/firefox-baseline-win11';
  };
      ...
      <section className="relative pt-32 pb-12 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-white via-cyan-200 to-blue-400 bg-clip-text text-transparent">
            Firefox Security Baseline Script Assistant for Windows 11
          </h1>
          <p className="text-lg text-slate-400 max-w-4xl leading-relaxed">
            ...
            safely on Windows 11 systems you manage. It is designed for people who want a repeatable Firefox baseline
            without hand-writing every <code className="text-xs bg-slate-950 px-2 py-0.5 rounded border border-blue-900/60 text-blue-300">policies.json</code> rule.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-900/80 backdrop-blur-sm rounded-2xl border border-slate-700 p-8">
            ...
            <p className="text-slate-400 mb-4 leading-relaxed">
              ...
              into a single PowerShell script. You choose the protections you want, and the tool generates a
              script that:
            </p>
            <ul className="space-y-2 text-slate-400 mb-4">
              <li>• Discovers the Firefox installation path on Windows 11.</li>
              <li>• Creates or updates the <code className="text-xs bg-slate-950 px-2 py-0.5 rounded border border-blue-900/60 text-blue-300">distribution</code> folder for enterprise policies.</li>
              <li>• Backs up any existing <code className="text-xs bg-slate-950 px-2 py-0.5 rounded border border-blue-900/60 text-blue-300">policies.json</code> to a timestamped file.</li>
            ...
            <p className="text-sm text-slate-400 mb-4 leading-relaxed">
              ...
              Windows system-wide TLS or DNS settings. It focuses on browser-level policies that Firefox
              supports through its enterprise configuration model.
            </p>
          ...
          <div className="bg-slate-900/80 backdrop-blur-sm rounded-2xl border border-slate-700 p-8">
            ...
            <p className="text-slate-400 mb-4 leading-relaxed">
              This assistant is meant for people who want stronger Firefox defaults on managed Windows 11 devices,
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-1.5 text-sm text-slate-400">
                  <li>• Home lab builders who want consistent Firefox settings across a few machines.</li>
                  <li>• Small business owners hardening staff browsers on Windows PCs they control.</li>
                  <li>• Admins who prefer readable PowerShell scripts over opaque GPO exports.</li>
              ...
              <div>
                ...
                <ul className="space-y-1.5 text-sm text-slate-400 mb-3">
                  <li>• Corporate or school-owned laptops that are already managed via GPO or MDM.</li>
      ...
      <section className="px-4 pb-12">
        <div className="max-w-7xl mx-auto bg-slate-900/80 backdrop-blur-sm rounded-2xl border border-slate-700 p-8">
          ...
          <p className="text-slate-400 mb-6 leading-relaxed">
            ...
            <strong className="text-slate-300"> Generate PowerShell script</strong>, it assembles a script locally based on your selections.
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400 mb-4">
                <li>• Use this only on Windows 11 systems that you own or are explicitly allowed to manage.</li>
                <li>• Create a restore point or a full backup of at least one test system.</li>
                ...
                <li>• Plan to test on a non-critical machine first.</li>
              </ul>
              <p className="text-sm text-slate-400 leading-relaxed">
                The script modifies <code className="text-xs bg-slate-950 px-2 py-0.5 rounded border border-blue-900/60 text-blue-300">policies.json</code> for Firefox. It does not undo
                existing GPOs or MDM profiles and does not manage Windows registry keys
                outside of the Firefox enterprise policy file.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400 mb-3">
                <li>• Save the script as something like <code className="text-xs bg-slate-950 px-2 py-0.5 rounded border border-blue-900/60 text-blue-300">firefox-baseline.ps1</code>.</li>
                <li>• Open PowerShell as Administrator on the Windows 11 device.</li>
                <li>• Review the path comments and adjust Firefox locations if needed.</li>
                <li>• Run <code className="text-xs bg-slate-950 px-2 py-0.5 rounded border border-blue-900/60 text-cyan-300">Invoke-FirefoxBaseline</code> to apply your chosen controls.</li>
                <li>• Use <code className="text-xs bg-slate-950 px-2 py-0.5 rounded border border-blue-900/60 text-cyan-300">Invoke-FirefoxBaselineRollback</code> to restore the most recent backup of <code className="text-xs bg-slate-950 px-2 py-0.5 rounded border border-blue-900/60 text-blue-300">policies.json</code>.</li>
              </ul>
              <p className="text-sm text-slate-400 leading-relaxed">
                The rollback function only restores backups that this script created. It will not recover
                other configuration changes, browser extensions, or user profile tweaks made outside of
                <code className="text-xs bg-slate-950 px-2 py-0.5 rounded border border-blue-900/60 text-blue-300"> policies.json</code>.
              </p>
            </div>
          </div>

          <p className="text-sm text-slate-400 mb-6 leading-relaxed">
            If you later adopt Group Policy or a centralized management solution, you can stop using this script and
            migrate the same policies into your preferred tooling. Think of this assistant as a bridge between
            "clicking around in settings" and a full enterprise config stack.
          </p>

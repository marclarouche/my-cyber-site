    ...
    linux: [
      {
        ...
        pillType: 'bash',
        toolUrl: '/security-center/browser-hardening-hub/chrome-baseline-linux',
        aboutUrl: '/security-center/browser-hardening-hub/about-chrome-baseline-linux'
      },
      {
        id: 'firefox-linux',
        name: 'Firefox',
        ...
        pillType: 'bash',
        toolUrl: '/security-center/browser-hardening-hub/firefox-baseline-linux',
        aboutUrl: '/security-center/browser-hardening-hub/about-firefox-baseline-linux'
      }
    ]
  };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-slate-900/80 backdrop-blur-sm rounded-2xl border border-slate-700 p-8 mb-8">
            ...
            <p className="text-slate-400 text-sm mb-6">
              This keeps things simple for non-experts. Choose Windows 11 or macOS to see the matching browser tools. Linux profiles are live.
            </p>

  ...
  <span className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent group-hover:brightness-125 transition-all duration-300">
    CyberLifeCoach
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button className="group px-8 py-4 rounded-lg font-semibold text-lg border-2 border-slate-700 hover:border-cyan-500 transition-all duration-300 flex items-center space-x-2">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto">
              Tailored security solutions designed to protect what matters most to you.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="group bg-gradient-to-br from-slate-900 to-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10 hover:-translate-y-2">
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Free Security Tools</h2>
            <p className="text-xl text-slate-400 max-w-2xl mx-auto">
              Professional-grade tools to help you take control of your digital security right now.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-900 p-8 rounded-2xl border border-slate-800 hover:border-cyan-500/50 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold mb-3">Password Strength Checker</h3>
              <p className="text-slate-400 mb-6">Analyze your passwords and get recommendations for stronger security.</p>
            ...
            <div className="bg-slate-900 p-8 rounded-2xl border border-slate-800 hover:border-cyan-500/50 transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold mb-3">Privacy Audit Tool</h3>
              <p className="text-slate-400 mb-6">Scan your digital footprint and identify potential privacy risks.</p>
              <button className="flex items-center space-x-2 text-cyan-400 hover:text-cyan-300 font-semibold group">
                <span>Try Now</span>
                <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </button>

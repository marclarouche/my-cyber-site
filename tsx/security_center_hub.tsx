  ...
  const securityTools = [
    {
      ...
      title: "Windows 11 Hardening Pack",
      ...
      aboutLink: "/security-center/windows-11-hardening/about"
    },
    {
      ...
      aboutLink: "/security-center/macos-secure-setup/about"
    },
    {
      ...
      aboutLink: "/security-center/linux-secure-setup/about"
    },
    {
      icon: <Globe className="w-10 h-10" />,
      title: "Browser Hardening Toolkit",
      ...
      difficulty: "Beginner",
      link: "/security-center/browser-hardening",
      aboutLink: "/security-center/browser-hardening/about"
    },
    {
      icon: <Network className="w-10 h-10" />,
      title: "Firewall Baseline Center",
      description: "Generate firewall rules and baseline configurations for Windows Firewall, iptables, UFW, and pfSense.",
      platform: "Cross-Platform",
      difficulty: "Advanced",
      link: "/security-center/firewall-baseline",
      aboutLink: "/security-center/firewall-baseline/about"
    },
    {
      ...
      platform: "Cloud",
      difficulty: "Intermediate",
      link: "/security-center/onedrive-lockdown",
      aboutLink: "/security-center/onedrive-lockdown/about"
    },
    {
      ...
      platform: "Assessment",
      difficulty: "Beginner",
      link: "/security-center/business-assessment",
      aboutLink: "/security-center/business-assessment/about"
    },
    {
      ...
      platform: "Cloud",
      difficulty: "Intermediate",
      link: "/security-center/office365-baseline",
      aboutLink: "/security-center/office365-baseline/about"
    }
  ];
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm">
                  For enterprise deployments or assistance with implementation, schedule a consultation with our security experts.
                </p>
              </div>
            </div>
          </div>
